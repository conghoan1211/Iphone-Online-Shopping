 ...
 * @author admin
 */
@WebServlet(name = "ManagerCateServlet", urlPatterns = {"/add.category"})
public class AddCateServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        int cnt = mdao.getAmountOfCategory();

        request.setAttribute("amount_cate", cnt);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ManagerDAO mdao = new ManagerDAO();
            Category c = mdao.getCategoryByID(cateID);

            if (c != null) {
                ms = "Mã thể loại hàng này đã tồn tại. Vui lòng thử lại.";
            } else {
                boolean add = mdao.insertCategory(cateID, cateName);
                if (add) {
                    ms = "Đã cập nhật thành công.";
                } else {
                    ms = "Có lỗi xảy ra. Vui lòng thử lại.";
                }
            }
